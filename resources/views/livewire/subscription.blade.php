<div>
    ...
    <section id="pricing" class="pricing-table section">
            ...
            <div class="row">
                <!-- Pricing Card -->
                <div class="col-lg-6 col-md-8 col-14 wow fadeInUp" data-wow-delay=".4s">
                    <!-- Single Table -->
                    <div class="single-table">
                        <!-- Table Head -->
                        <div class="table-head">
                            <h4 class="title">FOTOGRAFO</h4>
                        ...
                        <!-- End Table Content -->
                                ...
                                @if (auth()->user()->subscribedToPrice('price_1OBACXI8FqBZA7t0ja165hbQ', 'FOTOGRAFO PLANES'))
                                    {{-- Suscrito --}}

                                    @if (auth()->user()->subscription('FOTOGRAFO PLANES')->onGraceperiod())
                                    ...
                                    @endif
                                @else
                                    <x-button wire:click="newSubscription('price_1OBACXI8FqBZA7t0ja165hbQ')"
                                        wire:target="newSubscription('price_1OBACXI8FqBZA7t0ja165hbQ')"
                ...
                <!-- Pricing Card -->
                <div class="col-lg-6 col-md-8 col-14 wow fadeInUp" data-wow-delay=".6s">
                    <!-- Single Table -->
                    <div class="single-table middle">
                        ...
                        <!-- End Table Content -->
                        @if (auth()->user()->subscribedToPrice('price_1OBABDI8FqBZA7t0Wg2drQyV', 'FOTOGRAFO PLANES'))
                        {{-- Suscrito --}}
                        ...
                        @endif
                    @else
                        <x-button wire:click="newSubscription('price_1OBABDI8FqBZA7t0Wg2drQyV')"
                            wire:target="newSubscription('price_1OBABDI8FqBZA7t0Wg2drQyV')"
                            wire:loading.attr="disabled">
