            ...
            <div class="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0">
                ...
                <div
                    ...
                    <ul role="list" class="mb-8 space-y-4 text-left">
                        <li class="flex items-center space-x-3">
                            <!-- Icon -->
                            {{-- <svg class="flex-shrink-0 w-4 h-4 text-green-500 dark:text-green-400" fill="currentColor"
                    ...
                    @if (auth()->user()->subscribedToPrice('price_1OHAbwIb7vg6dnmcDPJgYEbs', 'parcial'))
                        {{-- Suscrito --}}

                        @if (auth()->user()->subscription('parcial')->onGraceperiod())
                    ...
                    @else
                        <x-button wire:click="newSubscription('price_1OHAbwIb7vg6dnmcDPJgYEbs')"
                            ...
                            <x-spinner size="4" wire:target="newSubscription('price_1OHAbwIb7vg6dnmcDPJgYEbs')"
                                wire:loading />
                            Suscribirse
                        </x-button>
                    @endif
                ...
                <div
                    ...
                    @if (auth()->user()->subscribedToPrice('price_1OHAbxIb7vg6dnmckOXDbIBS', 'parcial'))
                        ...
                        @endif
                    @else
                        <x-button wire:click="newSubscription('price_1OHAbxIb7vg6dnmckOXDbIBS')"
                            wire:target="newSubscription('price_1OHAbxIb7vg6dnmckOXDbIBS')"
                            wire:loading.attr="disabled">
                            {{-- Animacion de carga --}}
                            ...
                            <x-spinner size="4" wire:target="newSubscription('price_1OHAbxIb7vg6dnmckOXDbIBS')"
                                wire:loading />
                            Suscribirse
                        </x-button>
                    @endif
