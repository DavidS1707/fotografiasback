...
<body>
    ...
    <div id="main">
        ...
        <div class="head">
            <div class="col-div-6">
                <span style="font-size:30px;cursor:pointer; color: white;" class="nav">☰ Registrar invitado</span>
                <span style="font-size:30px;cursor:pointer; color: white;" class="nav2">☰ Registrar invitado</span>
            </div>
        ...
        <form class="w-100" method="POST" action="{{ route('registrar_invitacion') }}">
            @csrf
                    ...
                    <div class="row gx-3">
                        <div class="form-group col-lg-12">
                            ...
                            <input class="form-control  @error('nombre') is-invalid @enderror" id="nombre"
                                name="nombre" name="nombre" type="text" value="{{ old('nombre') }}">
                            @error('nombre')
