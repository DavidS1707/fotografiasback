...
<body>
    ...
    <div id="main">
        {{-- <form class="w-100" id="createEventForm">
            @csrf
                    ...
                    <div class="card-body">
                        <div class="row gx-3">
                            <div class="form-group col-lg-12">
                                ...
                                <input class="form-control  @error('titulo_evento') is-invalid @enderror"
                                    id="titulo_evento" name="titulo_evento" name="titulo_evento" type="text"
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <select id="fotografos" name="fotografos[]"
                                    class="form-select me-3 @error('fotografos') is-invalid @enderror"
            ...
            <button type="button" class="btn btn-primary btn-rounded btn-uppercase btn-block"
                onclick="submitForm()">Registrar Evento</button>
        </form> --}}
